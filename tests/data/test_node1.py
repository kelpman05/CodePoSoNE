...
gasdemand = gasdemand_raw.loc[1, 'T12']
elecdemand = elecdemand_raw.loc[1, 'T12']
heatdemand = heatdemand_raw.loc[1, 'T12']
cooldemand = cooldemand_raw.loc[1, 'T12']
#####################################################
